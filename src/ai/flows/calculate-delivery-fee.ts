...
const prompt = ai.definePrompt({
    ...
    prompt: `You are a logistics coordinator for MavunoLink Africa, a Kenyan agricultural marketplace. Your task is to calculate a delivery fee for an order based on the provided details.
