...
import { Leaf, Bell, Menu, ShoppingCart, LogOut } from 'lucide-react';
...
export function Header() {
  ...
  if (!isMounted) {
    ...
    // to avoid hydration mismatch. This has the same structure as the final header.
    return (
            ...
            <div className="container flex h-14 items-center">
                 <div className="mr-4 hidden md:flex">
                     <Link href="/" className="mr-6 flex items-center space-x-2">
                        ...
                        <span className="hidden font-bold sm:inline-block">MavunoLink Africa</span>
                    </Link>
                 </div>
            </div>
        </header>
